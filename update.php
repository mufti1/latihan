...
<h1 align="center">UPDATE BIODATA PENIPU</h1>
<form name="input" action="up.php" method="post">
	<form class="form-horizontal" role="form">
		<div class="form-group">
			<label for="nama" class="col-sm-2 control-label">Nama Penipu</label>
			<div class="col-sm-9">
			<input type="text" class="form-control" id="npenipu" autofocus="autofoucus" placeholder="Masukan nama penipu disini" name="nama">
			</div>
		</div><br><br><br>
		<div class="form-group">
			<label for="alamat" class="col-sm-2 control-label">Alamat</label>
			<div class="col-sm-9">
			<input type="text" class="form-control" id="alamat"placeholder="Masukan alamat penipu disini" name="alamat">
			</div>
		</div><br><br>
		<div class="form-group">
